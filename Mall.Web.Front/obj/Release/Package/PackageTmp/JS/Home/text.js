        ...
        if (!options.adaptive) {
            $item.each(function () {
                ...
                if ($img.attr('data-src')) {
                    ...
                    $(this).css({ 'backgroundImage': 'url(' + src + ')', 'background-size': '935px 500px' });
                }
    ...
    Banner.prototype.lazyload = function () {
        ...
        function showVisibleItem() {
            ...
            if (options.adaptive) {
                ...
                $visibleItem.css({ 'backgroundImage': 'url(' + src + ')', 'background-size': '935px 500px' });
            }
