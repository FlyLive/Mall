...
namespace Mall.Service.Services.Client
{
    public class MenuViewService
    {
        public static List<CustomMenu> _menuView { get; } = new List<CustomMenu>
        {
            ...
            new CustomMenu { MenuId = 3,Name = "修改资料",Icon="fa fa-edit",Url = "/Account/PersonalInfo",ParentId = 1 },
            new CustomMenu { MenuId = 4,Name = "地址管理",Icon="fa fa-map-marker",Url = "/Account/AddressSet",ParentId = 1 },
            new CustomMenu { MenuId = 5,Name = "安全设置",Icon="fa fa-lock",Url = "/Account/SecuritySet",ParentId = 1 },
            new CustomMenu { MenuId = 7,Name = "全部订单",Icon="fa fa-reorder",Url = "/Order",ParentId = 2 },
